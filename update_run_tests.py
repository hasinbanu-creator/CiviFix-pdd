...
with open("selenium_tests/run_tests.py", "r") as f:
    content = f.read()

new_content = """\"\"\"Selenium test runner and report generator\"\"\"
import subprocess
import os
import json
import logging
...
class SeleniumTestRunner:
    ...
    def generate_excel_report(self):
        ...
        template_path = "../Execution_Report.xlsx"
...
with open("selenium_tests/run_tests.py", "w") as f:
    f.write(new_content)
